...
;define("employee-management-ember/components/index/component", ["exports", "@glimmer/component"], function (_exports, _component) {
  ...
  _exports.default = void 0;
  class EmployeeFormComponent extends _component.default {
    model() {}
  }
...
;define("employee-management-ember/templates/index", ["exports"], function (_exports) {
  ...
  var _default = _exports.default = Ember.HTMLBars.template({
    "id": "wUbc93D5",
    "block": "{\"symbols\":[],\"statements\":[[8,\"index\",[],[[\"@model\"],[[32,0,[\"model\"]]]],[[\"default\"],[{\"statements\":[],\"parameters\":[]}]]]],\"hasEval\":false,\"upvars\":[]}",
    "meta": {
...
;
          if (!runningTests) {
            require("employee-management-ember/app")["default"].create({"name":"employee-management-ember","version":"0.0.0+2be14486"});
          }
